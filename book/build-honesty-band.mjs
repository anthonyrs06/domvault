#!/usr/bin/env node
/**
 * book/build-honesty-band.mjs — builds "The Honesty Band" from the single
 * compiled manuscript in book/sources/honesty-band.md.
 *
 ...
 * chapters and emits:
 *   book/dist-honesty-band/index.html  — the web book (dark, cosmic, long-form)
 *   book/dist-honesty-band/print.html  — 6x9in print interior (black on white)
 *
 * Usage: node book/build-honesty-band.mjs
 */
...
const SRC = join(HERE, 'sources', 'honesty-band.md');
const DIST = join(HERE, 'dist-honesty-band');

const BOOK = {
  title: 'The Honesty Band',
  subtitle: 'Shipping AI That Never Overclaims',
  ...
  requiredNotice:
    'Required Notice: Copyright (c) 2026 Dom Sadarangani (Domvault / The Honesty Band)',
  year: 2026,
